<div class="about" style="background-image: url('/about.png')">
  ...
  <div class="about__content">
    ...
    <div class="about__icon-card">
      <?=icon('3d')?>
      <p class="about__icon-card-title">Modeling</p>
    </div>

    <div class="about__icon-card">
      <?=icon('3d')?>
      <p class="about__icon-card-title">Visualization</p>
    </div>

    <div class="about__icon-card">
      <?=icon('3d')?>
      <p class="about__icon-card-title">Animation</p>
    </div>

  </div>
  <div class="about__dark-bg"></div>
</div>